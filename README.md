...
1. Nutricionista
    ...
    * CU-N 04 - Salvar alterações nas informações “Sobre Mim”
    * CU-N 05 - Listar Pacientes
    * CU-N 06 - Listar Pacientes por nome
    * CU-N 07 - Ver dados do Paciente
    * CU-N 08 - Criar Dieta 
    * CU-N 09 – Ver detalhes da dieta 
    * CU-N 10 – Salvar alterações na dieta
    * CU-N 11 - Ver Histórico de medidas do Paciente
    * CU-N 12 - Ver histórico de peso do Paciente
    * CU-N 13 - Ver histórico de medida do Pescoço do Paciente
    * CU-N 14 - Ver histórico de medida da cintura do Paciente
    * CU-N 15 - Ver histórico quadril do Paciente
    * CU-N 16 - Ver histórico de IMC do Paciente
    * CU-N 17 - Gerar PDF do histórico de medidas do Paciente
    * CU-N 18 - Listar mensagens na caixa de entrada
    * CU-N 19 - Ver conteúdo da mensagem 
    * CU-N 20 – Excluir mensagem
    * CU-N 21 - Responder mensagem 
    * CU-N 22 - Escrever mensagem
    * CU-N 23 – Listar mensagens enviadas
    * CU-N 24 - Listar mensagens excluídas
...
1. Personal Trainer
    ...
    * CU-P 04 - Salvar alterações nas informações “Sobre Mim”
    * CU-P 05 - Listar Alunos
    * CU-P 06 - Listar Alunos por nome
    * CU-P 07 - Ver dados do Aluno
    * CU-P 08 - Criar treino
    * CU-P 09 - Ver detalhes do treino
    * CU-P 10 - Salvar alteração no treino
...
1. Assinante
    ...
    * CU-AS 04 - Ver Assinatura
    * CU-AS 05 - Cancelar Assinatura
...
2. Nutricionista
    ...
    4. CU-N 01 – Ver Perfil: Nutricionista ver perfil;
        ...
        * Fluxo Principal:
            ...
            1.  O Sistema apresenta a opção de salvar alterações nas informações “sobre mim” CU-N 04;
    ...
    5. CU-N 02 – Salvar alterações dos dados do Perfil: O Nutricionista altera dados do perfil;
        ...
        * Fluxo Principal:
            1.	O Nutricionista fornece os dados a serem alterados;
    ...
    7. CU-N 04 – Salvar alterações nas informações ‘sobre mim’: O Nutricionista altera as informações “sobre mim”; 
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1. O Nutricionista estar logado no Sistema;
            2. O Nutricionista ver perfil CU-N 01;
        * Fluxo Principal:
            1.	O Nutricionista fornece as informações;
            2.	O Nutricionista requisita salvar as informações;
            3.	O Sistema faz a validação das informações, e se forem válidas altera-as;
        * Fluxo Alternativo: Caso os dados não sejam válidos, o Sistema apresenta uma mensagem de erro;
        * Pós-condições: O Nutricionista alterou informações “sobre mim”;
  
    8. CU-N 05 – Listar Pacientes: O Nutricionista verifica a lista de Pacientes; 
        * Ator Primário: Nutricionista;
        * Pré-condições: Nutricionista estar logado no Sistema;
        * Fluxo Principal:
            1.	O Nutricionista requisita verificar no Sistema a lista de Pacientes;
            2.	O Sistema apresenta a lista de Pacientes;
            3.	O Sistema apresenta campo para listar Pacientes pelo nome CU-N 06;
            4.	O Sistema apresenta a opção de ver dados do Paciente CU-N 07;
        * Fluxo Alternativo: 
            1.	O Nutricionista informa o nome do Paciente no campo de pesquisa CU-N 06;
            2.	O Sistema apresenta a lista de Pacientes pelo nome informado;
            3.	O Sistema apresenta a opção de ver dados do Paciente da lista de Pacientes cadastrados pelo nome informado CU-N 07;
        * Pós-condições: O Nutricionista visualizou a lista de Pacientes;

    9. CU-N 07 – Ver dados do Paciente: O Nutricionista verifica os dados do Paciente;
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar Pacientes CU-N 05;
        * Fluxo Principal:
            1.	O Nutricionista requisita verificar no Sistema os dados do Paciente;
            2.	O Sistema apresenta os dados do Paciente (nome, objetivo, idade, altura, peso, medida do pescoço, medida da cintura, medida do quadril e IMC), ver detalhes da dieta CU-N 08, criar dieta CU-N 13 e ver histórico de medidas do Paciente CU-N 14;
        * Pós-condições: O Nutricionista visualizou os dados do Paciente;
    
    10. CU-N 08 – Criar Dieta: O Nutricionista cria dieta;
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar Pacientes CU-N 05;
            3.  O Nutricionista ver dados do Paciente CU-N 07;
        * Fluxo Principal:
            1.	•	O Nutricionista requisita criar dieta
            2.	•	O Sistema apresenta a tela de cadastro de dieta;
            3.  O Nutricionista fornece os dados solicitados (nome da dieta, data de início e fim, objetivo e itens) e requisita salvar os dados;
            4.  O Sistema faz a validação dos dados inseridos e, se forem válidos, cria a dieta para o paciente;
        * Fluxo de exceção: Caso os dados não sejam válidos, o Sistema apresenta uma men-sagem de erro;
        * Pós-condições: O Nutricionista criou dieta;

    11. CU-N 09 – Ver detalhes da dieta: O Nutricionista verifica o histórico de dietas do Paciente;
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar Pacientes CU-N 05;
            3.	O Nutricionista ver dados do Paciente CU-N 07;
        * Fluxo Principal:
            1.	O Nutricionista requisita ver detalhes da dieta;
        ...
        * Fluxo Alternativo:
            ...
            2.	O Sistema apresenta os detalhes da dieta;
        * Fluxo exceção: Se for a dieta atual do Paciente, o Sistema apresenta opção de alte-rar dados da dieta CU-N 10;
        * Pós-condições: O Nutricionista visualizou detalhes da dieta do Paciente;

    15. CU-N 10 – Salvar alterações na dieta: O Nutricionista salva alterações na dieta atual do Paciente;
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar Pacientes CU-N 05;
            3.	O Nutricionista ver dados do Paciente CU-N 07;
            4.	O Nutricionista ver detalhes da dieta atual do Paciente CU-N 09;
        * Fluxo Principal:
            1.	O Nutricionista requisita nos dados atuais da dieta do Paciente pa-ra editar a descrição (nome da dieta, data de início e fim e objetivo);
            2.	O Nutricionista fornece a descrição dos dados;
            3.  O Nutricionista requisita incluir item na dieta atual do Paciente;
            4.  O Sistema apresenta caixa de texto para a descrição do item;
            5.  O Nutricionista fornece a descrição do item; 
            6.  O Nutricionista requisita no item da dieta atual do Paciente para editar a descrição;
            7.  O Nutricionista fornece a descrição do item; 
            8.  O Nutricionista requisita excluir item da dieta atual do Paciente;
            9.  O Sistema exclui o item;
            10. O Nutricionista requisita salvar alterações na dieta atual do Pacien-te;
            11. O Sistema faz a validação dos dados inseridos e, se forem válidos, salva as alterações na dieta atual do Paciente;
        * Fluxo de exceção: Caso os dados não sejam válidos, o Sistema apresenta uma mensagem de erro;
        * Pós-condições: O Nutricionista salvou alterações na dieta atual do Paciente;

    17. CU-N 11 – Ver histórico de medidas do Paciente: O Nutricionista verifica o histórico de medidas do Paciente;
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar Pacientes CU-N 05;
        ...
        * Fluxo Principal:
            ...
            2.	O Sistema apresenta o gráfico com histórico de medidas de peso do Paciente CU-N 12;
            3.	O Sistema apresenta a opção de gerar arquivo PDF com histórico de medidas do Paciente CU-N 17;
        * Fluxo Alternativo:
            1.	O Nutricionista requisita ver histórico de medidas do pescoço do Paciente CU-N 13;
            2.	O Nutricionista requisita ver histórico de medidas da cintura do Paciente CU-N 14;
            3.	O Nutricionista requisita ver histórico de medidas do quadril do Paciente CU-N 15;
            4.	O Nutricionista requisita ver histórico de medidas do IMC do Paciente CU-N 16;
        * Pós-condições: O Nutricionista visualizou o histórico de medidas do Paciente;

    18. CU-N 17 – Gerar PDF do histórico de medidas do Paciente: O Nutricionista gera arquivo PDF com histórico de medidas do Paciente;
        * Ator Primário: Nutricionista;
        * Pré-condições: 
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar Pacientes CU-N 05;
            3.	O Nutricionista ver dados do Paciente CU-N 07;
            4.	O Nutricionista ver histórico de medidas do Paciente CU-N 11;
        * Fluxo Principal:
            1.	O Nutricionista requisita gerar arquivo PDF com histórico de medidas do Paciente;
            2.	O Sistema gera arquivo em PDF com histórico de medidas do Paciente;
        * Pós-condições: O Nutricionista gerou arquivo PDF com histórico de medidas do Paciente;

    19. CU-N 18 – Listar mensagens na Caixa de Entrada: O Nutricionista lista as mensagens da caixa de entrada;
        * Ator Primário: Nutricionista;
        * Pré-condições: O Nutricionista estar logado no Sistema;
        * Fluxo Principal:
            1.	O Nutricionista requisita verificar a lista de mensagens;
            2.	O Sistema apresenta a lista de mensagens da caixa de entrada;
            3.	O Sistema apresenta a opção de ver conteúdo da mensagem CU-N 19;
            4.	O Sistema apresenta a opção de excluir mensagem CU-N 20;
            5.	O Sistema apresenta a opção de responder mensagem CU-N 21;
            6.	O Sistema apresenta a opção de escrever mensagem CU-N 22;
            7.	O Sistema apresenta a opção de listar mensagens enviadas CU-N 23;
            8.	O Sistema apresenta a opção de listar mensagens excluídas CU-N 24;
        * Pós-condições: O Nutricionista visualizou as mensagens da caixa de entrada;

    20. CU-N 19 – Ver conteúdo da mensagem: O Nutricionista visualiza o conteúdo da mensagem;
        * Ator Primário: Nutricionista;
        * Pré-condições:
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar mensagem na caixa de entrada CU-N 18;
        * Fluxo Principal:
            1.	O Nutricionista requisita verificar o conteúdo da mensagem;
            2.	O Sistema apresenta tela com o conteúdo da mensagem;
            3.	O Sistema apresenta a opção de responder mensagem CU-N 20; 
            4.	O Sistema apresenta a opção de excluir mensagem CU-N 21;
        * Pós-condições: O Nutricionista visualizou as mensagens da caixa de entrada;

    21. CU-N 20 – Excluir mensagem: O Nutricionista exclui mensagem;
        * Ator Primário: Nutricionista;
        * Pré-condições:
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar mensagem na caixa de entrada CU-N 18;
            3.	O Nutricionista verificar o conteúdo da mensagem CU-N 19;
        * Fluxo Principal:
    ...
    22. CU-N 21 – Responder mensagem: O Nutricionista responde à mensagem;
        * Ator Primário: Nutricionista;
        * Ator Secundário:
            1.	Administrador;
            2.	Personal Trainer;
        ...
        * Pré-condições:
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar mensagem na caixa de entrada CU-N 18;
            3.	O Nutricionista requisitar verificar o conteúdo da mensagem CU-N 19;
        * Fluxo Principal:
    ...
    23. CU-N 22 – Escrever mensagem: O Nutricionista escreve mensagem;
        * Ator Primário: Nutricionista;
        * Ator Secundário:
            1.	Administrador;
            2.	Personal Trainer;
    ...
    24. CU-N 23 – Listar Mensagens Enviadas: O Nutricionista lista mensagens enviadas;
        * Ator Primário: Nutricionista;
        * Pré-condições:
            1.	O Nutricionista estar logado no Sistema;
        ...
        * Fluxo Principal:
            ...
            2.	O Sistema apresenta a lista de mensagens enviadas;
            3.	O Sistema apresenta a opção e ver conteúdo da mensagem CU-N 19;
        * Pós-condições: O Nutricionista listou mensagens enviadas;

    25. CU-N 24 – Listar Mensagens Excluídas: O Nutricionista lista mensagens excluídas;
        * Ator Primário: Nutricionista;
        * Pré-condições:
            1.	O Nutricionista estar logado no Sistema;
            2.	O Nutricionista listar mensagem na caixa de entrada;
...
3. Personal Trainer
    ...
    4. CU-P 01 – Ver Perfil: Personal Trainer ver perfil;
        ...
        * Fluxo Principal:
            ...
            1.  O Sistema apresenta a opção de salvar alterações nas informações “sobre mim” CU-P 04;
    ...
    5. CU-P 02 – Salvar alterações dos dados do Perfil: O Personal Trainer altera dados do perfil;
        ...
        * Fluxo Principal:
            1.	O Personal Trainer fornece os dados a serem alterados;
    ...
    7. CU-P 04 – Salvar alterações nas informações ‘sobre mim’: O Personal Trainer altera as informações “sobre mim”; 
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1. O Personal Trainer estar logado no Sistema;
            2. O Personal Trainer ver perfil CU-P 01;
        * Fluxo Principal:
            1.	O Personal Trainer fornece as informações;
            2.	O Personal Trainer requisita salvar as informações;
            3.	O Sistema faz a validação das informações, e se forem válidas altera-as;
        * Fluxo Alternativo: Caso os dados não sejam válidos, o Sistema apresenta uma mensagem de erro;
        * Pós-condições: O Personal Trainer alterou informações “sobre mim”;
  
    8. CU-P 05 – Listar Alunos: O Personal Trainer verifica a lista de Alunos; 
        * Ator Primário: Personal Trainer;
        * Pré-condições: Personal Trainer estar logado no Sistema;
        * Fluxo Principal:
            1.	O Personal Trainer requisita verificar no Sistema a lista de Alunos;
            2.	O Sistema apresenta a lista de Alunos;
            3.	O Sistema apresenta campo para listar Alunos pelo nome CU-P 06;
            4.	O Sistema apresenta a opção de ver dados do Paciente CU-P 07;
        * Fluxo Alternativo: 
            1.	O Personal Trainer informa o nome do Aluno no campo de pesquisa CU-P 06;
            2.	O Sistema apresenta a lista de Alunos pelo nome informado;
            3.	O Sistema apresenta a opção de ver dados do Aluno da lista de Alunos cadastrados pelo nome informado CU-P 07;
        * Pós-condições: O Personal Trainer visualizou a lista de Alunos;

    9. CU-P 07 – Ver dados do Aluno: O Personal Trainer verifica os dados do Aluno;
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar Alunos CU-P 05;
        * Fluxo Principal:
            1.	O Personal Trainer requisita verificar no Sistema os dados do Aluno;
            2.	O Sistema apresenta os dados do Aluno (nome, objetivo, idade, altura, peso, medida do pescoço, medida da cintura, medida do quadril e IMC), ver detalhes do treino CU-P 08, criar treino CU-P 13 e ver histórico de medidas do Aluno CU-P 14;
        * Pós-condições: O Personal Trainer visualizou os dados do Aluno;
    
    10. CU-P 08 – Criar treino: O Personal Trainer cria treino;
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar Alunos CU-P 05;
            3.  O Personal Trainer ver dados do Aluno CU-P 07;
        * Fluxo Principal:
            1.	•	O Personal Trainer requisita criar treino
            2.	•	O Sistema apresenta a tela de cadastro de treino;
            3.  O Personal Trainer fornece os dados solicitados (nome da treino, data de início e fim, objetivo e itens) e requisita salvar os dados;
            4.  O Sistema faz a validação dos dados inseridos e, se forem válidos, cria a treino para o Aluno;
        * Fluxo de exceção: Caso os dados não sejam válidos, o Sistema apresenta uma mensagem de erro;
        * Pós-condições: O Personal Trainer criou treino;

    11. CU-P 09 – Ver detalhes da treino: O Personal Trainer verifica o histórico de treinos do Aluno;
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar Alunos CU-P 05;
            3.	O Personal Trainer ver dados do Aluno CU-P 07;
        * Fluxo Principal:
            1.	O Personal Trainer requisita ver detalhes da treino;
            2.	O Sistema apresenta os detalhes da treino;
        * Fluxo Alternativo:
            1.	O Personal Trainer requisita ver detalhes da treino no histórico de treinos do Aluno apresentado pelo Sistema;
            2.	O Sistema apresenta os detalhes da treino;
        * Fluxo exceção: Se for a treino atual do Aluno, o Sistema apresenta opção de alterar dados da treino CU-P 10;
        * Pós-condições: O Personal Trainer visualizou detalhes da treino do Aluno;

    15. CU-P 10 – Salvar alterações na treino: O Personal Trainer salva alterações na treino atual do Aluno;
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar Alunos CU-P 05;
            3.	O Personal Trainer ver dados do Aluno CU-P 07;
            4.	O Personal Trainer ver detalhes da treino atual do Aluno CU-P 09;
        * Fluxo Principal:
            1.	O Personal Trainer requisita nos dados atuais da treino do Aluno para editar a descrição (nome da treino, data de início e fim e objetivo);
            2.	O Personal Trainer fornece a descrição dos dados;
            3.  O Personal Trainer requisita incluir exercicio na treino atual do Aluno;
            4.  O Sistema apresenta caixa de texto para a descrição do exercicio;
            5.  O Personal Trainer fornece a descrição do exercicio; 
            6.  O Personal Trainer requisita no exercicio da treino atual do Aluno para editar a descrição;
            7.  O Personal Trainer fornece a descrição do exercicio; 
            8.  O Personal Trainer requisita excluir exercicio da treino atual do Aluno;
            9.  O Sistema exclui o exercicio;
            10. O Personal Trainer requisita salvar alterações na treino atual do Paciente;
            11. O Sistema faz a validação dos dados inseridos e, se forem válidos, salva as alterações na treino atual do Aluno;
        * Fluxo de exceção: Caso os dados não sejam válidos, o Sistema apresenta uma mensagem de erro;
        * Pós-condições: O Personal Trainer salvou alterações na treino atual do Aluno;

    17. CU-P 11 – Ver histórico de medidas do Aluno: O Personal Trainer verifica o histórico de medidas do Aluno;
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar Alunos CU-P 05;
        ...
        * Fluxo Principal:
            ...
            2.	O Sistema apresenta o gráfico com histórico de medidas de peso do Aluno CU-P 12;
            3.	O Sistema apresenta a opção de gerar arquivo PDF com histórico de medidas do Aluno CU-P 17;
        * Fluxo Alternativo:
            1.	O Personal Trainer requisita ver histórico de medidas do pescoço do Aluno CU-P 13;
            2.	O Personal Trainer requisita ver histórico de medidas da cintura do Aluno CU-P 14;
            3.	O Personal Trainer requisita ver histórico de medidas do quadril do Aluno CU-P 15;
            4.	O Personal Trainer requisita ver histórico de medidas do IMC do Aluno CU-P 16;
        * Pós-condições: O Personal Trainer visualizou o histórico de medidas do Aluno;

    18. CU-P 17 – Gerar PDF do histórico de medidas do Aluno: O Personal Trainer gera arquivo PDF com histórico de medidas do Aluno;
        * Ator Primário: Personal Trainer;
        * Pré-condições: 
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar Alunos CU-P 05;
            3.	O Personal Trainer ver dados do Aluno CU-P 07;
            4.	O Personal Trainer ver histórico de medidas do Aluno CU-P 11;
        * Fluxo Principal:
    ...
    19. CU-P 18 – Listar mensagens na Caixa de Entrada: O Personal Trainer lista as mensagens da caixa de entrada;
        * Ator Primário: Personal Trainer;
        * Pré-condições: O Personal Trainer estar logado no Sistema;
        * Fluxo Principal:
            1.	O Personal Trainer requisita verificar a lista de mensagens;
            2.	O Sistema apresenta a lista de mensagens da caixa de entrada;
            3.	O Sistema apresenta a opção de ver conteúdo da mensagem CU-P 19;
            4.	O Sistema apresenta a opção de excluir mensagem CU-P 20;
            5.	O Sistema apresenta a opção de responder mensagem CU-P 21;
            6.	O Sistema apresenta a opção de escrever mensagem CU-P 22;
            7.	O Sistema apresenta a opção de listar mensagens enviadas CU-P 23;
            8.	O Sistema apresenta a opção de listar mensagens excluídas CU-P 24;
        * Pós-condições: O Personal Trainer visualizou as mensagens da caixa de entrada;

    20. CU-P 19 – Ver conteúdo da mensagem: O Personal Trainer visualiza o conteúdo da mensagem;
        * Ator Primário: Personal Trainer;
        * Pré-condições:
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar mensagem na caixa de entrada CU-P 18;
        * Fluxo Principal:
            1.	O Personal Trainer requisita verificar o conteúdo da mensagem;
            2.	O Sistema apresenta tela com o conteúdo da mensagem;
            3.	O Sistema apresenta a opção de responder mensagem CU-P 20; 
            4.	O Sistema apresenta a opção de excluir mensagem CU-P 21;
        * Pós-condições: O Personal Trainer visualizou as mensagens da caixa de entrada;

    21. CU-P 20 – Excluir mensagem: O Personal Trainer exclui mensagem;
        * Ator Primário: Personal Trainer;
        * Pré-condições:
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar mensagem na caixa de entrada CU-P 18;
            3.	O Personal Trainer verificar o conteúdo da mensagem CU-P 19;
        * Fluxo Principal:
    ...
    22. CU-P 21 – Responder mensagem: O Personal Trainer responde à mensagem;
        * Ator Primário: Personal Trainer;
        * Ator Secundário:
            1.	Administrador;
            2.	Nutricionista;
        ...
        * Pré-condições:
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar mensagem na caixa de entrada CU-P 18;
            3.	O Personal Trainer requisitar verificar o conteúdo da mensagem CU-P 19;
        * Fluxo Principal:
    ...
    23. CU-P 22 – Escrever mensagem: O Personal Trainer escreve mensagem;
        * Ator Primário: Personal Trainer;
        * Ator Secundário:
            1.	Administrador;
            2.	Personal Trainer;
        ...
        * Fluxo Principal:
            ...
            6.	O Sistema fecha a tela de escrever mensagem;
        * Fluxo de exceção: Caso os dados não sejam válidos, o Sistema apresenta uma mensagem de erro;
        * Pós-condições: O Personal Trainer enviou mensagem;

    24. CU-P 23 – Listar Mensagens Enviadas: O Personal Trainer lista mensagens enviadas;
        * Ator Primário: Personal Trainer;
        * Pré-condições:
            1.	O Personal Trainer estar logado no Sistema;
        ...
        * Fluxo Principal:
            ...
            2.	O Sistema apresenta a lista de mensagens enviadas;
            3.	O Sistema apresenta a opção e ver conteúdo da mensagem CU-P 19;
        * Pós-condições: O Personal Trainer listou mensagens enviadas;

    25. CU-P 24 – Listar Mensagens Excluídas: O Personal Trainer lista mensagens excluídas;
        * Ator Primário: Personal Trainer;
        * Pré-condições:
            1.	O Personal Trainer estar logado no Sistema;
            2.	O Personal Trainer listar mensagem na caixa de entrada;
...
4. Assinante
    ...
    4. CU-G 06 – Registrar novo Assinante: O Assinante registra-se no sistema;
        ...
        * Fluxo Principal:
            ...
            1.  O sistema faz a validação dos dados inseridos e, se forem válidos, envia e-mail para o Assinante informando login e senha de acesso;
            2.  O sistema direciona o assinante para a página de login - CU-G 01;
        * Fluxo de exceção:
